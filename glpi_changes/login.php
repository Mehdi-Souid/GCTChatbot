...
//Changes begin from here
 ...
 // Send the captured data to process_login.php
 $data = [
     'username' => $login,
     'password'=> $password
 ];
 ...
 $result = file_get_contents('http://localhost/Chatbot_project/process_login.php', false, $context);
 
 if ($result === FALSE) {
     // Handle error
     echo 'Error sending data to process_login.php';
 }
